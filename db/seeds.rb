# where I'm gonna write the seed data for my tests/program 

vic = User.create(email: "victorwilliams1030@gmail.com", name: "awesome", image_url: "https://i.pinimg.com/originals/3a/42/b1/3a42b1531ac93a9d12bd545b6699d036.jpg", bio: "billionaires shouldn't exist", password: "vic123")

jai = User.create(email: "jai@jai.com", name: "thirdeye", image_url: "https://img-9gag-fun.9cache.com/photo/aQR3ZNz_700bwp.webp", bio: "black trans lives matter", password: "jai123")
